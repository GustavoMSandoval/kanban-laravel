...
<div class="modal fade" id="modal-comment-{{ $id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static"  data-bs-keyboard="false">
        ...
        <div  class="modal-body p-0" style="height: 70vh;">
          ...
          <div class="card border-0 h-100">
            <div class="card-body d-flex flex-column p-3" style="overflow-y: auto;">
              ...
              <div id="comments_list" class="d-flex flex-column align-items-end">
            ...
            <div class="card-footer d-flex align-items-center p-3">
              ...
              <form x-target="comments_list" class="w-100 d-flex align-items-center gap-4" method="POST" action="{{ route('comment.store') }}">
                @csrf
                <div class="w-100">
